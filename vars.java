...
public class vars {
    ...
    static int[]   depthsArray     = {10,12,14,16,18,20,22,25,30,35,40,42};
    static int[][] bottomTimeArray = 
            ...
            {-1,5,6,-1,7,8,9}, // 40
            {-1,4,-1,6,7,8}}; // 42
    static String[][]  surfaceTimeArray = 
            {{"0:00 to 3:00"}, // A
        ...
        public static int[][] ANDLArray = 
            ...
            {2,5,9,12,16,19,22,24,27,30,33,35,38,40,43,45,47,49,51,53,55,59,65}, // 16
        ...
        (String statement,String ErrorMessage,int minValue,int maxValue) {
